...
class MainWindow : public QMainWindow
{
    ...
    private:
        ...
        QString previewFor(
            navstud::validator::EntityKind kind,
            qint32 rawId,
            const navstud::conversion::RegenerationResult& result
        ) const;
        ...
        navstud::model::ApproachTransitionId    mCurrentApproachTransitionId    =
            navstud::model::ApproachTransitionId::invalid();
        ...
        navstud::model::ProcedureTransitionId   mCurrentSidProcedureTransitionId    =
                navstud::model::ProcedureTransitionId::invalid();
        ...
        navstud::model::ProcedureTransitionId   mCurrentStarProcedureTransitionId   =
                navstud::model::ProcedureTransitionId::invalid();
        ...
        navstud::model::RunwayProcedureTransitionId mCurrentSidRunwayProcedureTransitionId  =
                navstud::model::RunwayProcedureTransitionId::invalid();
        ...
        navstud::model::RunwayProcedureTransitionId mCurrentStarRunwayProcedureTransitionId =
                navstud::model::RunwayProcedureTransitionId::invalid();
